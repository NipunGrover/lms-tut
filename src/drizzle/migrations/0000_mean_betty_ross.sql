...
CREATE TYPE "public"."prouct_status" AS ENUM('public', 'private');--> statement-breakpoint
...
CREATE TABLE "products" (
	...
	"name" text NOT NULL,
	"description" text NOT NULL,
	"imageUel" text NOT NULL,
	"priceInDollars" integer NOT NULL,
	"status" "prouct_status" DEFAULT 'private' NOT NULL,
	"createdAt" timestamp with time zone DEFAULT now() NOT NULL,
	"updatedAt" timestamp with time zone DEFAULT now() NOT NULL
);
--> statement-breakpoint
ALTER TABLE "courseSections" ADD CONSTRAINT "courseSections_courseId_courses_id_fk" FOREIGN KEY ("courseId") REFERENCES "public"."courses"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "lessons" ADD CONSTRAINT "lessons_sectionId_courseSections_id_fk" FOREIGN KEY ("sectionId") REFERENCES "public"."courseSections"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
